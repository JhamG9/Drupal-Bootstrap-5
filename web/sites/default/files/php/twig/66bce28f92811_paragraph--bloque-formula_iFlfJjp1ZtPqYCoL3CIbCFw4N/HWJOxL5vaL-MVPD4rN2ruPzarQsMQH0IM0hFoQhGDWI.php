...
\t\t\t\t<h2 class=\"titulo-contacto\">";
        // line 6
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_titulo_contacto", [], "any", false, false, true, 6), 6, $this->source), "html", null, true);
        yield "</h2>
...
";
    ...
    {
        return array (  58 => 12,  51 => 8,  46 => 6,  40 => 2,);
    }
